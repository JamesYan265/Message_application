...
function Alert() {
  return(
    <>
      <div className='Alert'>*You must write something*</div>
    </>
  )
}
...
function MessageBox() {
  ...
  return (
    <div className='messageBox'>
      <form>
        <div className="MessageBox_input">
        ...
        {displayImage === "" ? (
          ...
          <>
            <img src={displayImage} alt="" className="displayBox" />
            <label className='ImageUpload_label'>
              <input className='messageBox_imageCancel' type="button" onClick={CancelUpdating}></input><DeleteIcon></DeleteIcon>
              Cancel Updating
            </label>
          </>   
        )}
